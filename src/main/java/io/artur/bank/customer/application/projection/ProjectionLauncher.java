...
public class ProjectionLauncher {
    ...
    private List<Projection<EventEnvelope<AccountEvent>>> singletonProjections = List.empty();
    private List<Projection<EventEnvelope<AccountEvent>>> localProjections = List.empty();
    ...
    public ProjectionLauncher withSingletonProjections(Projection<EventEnvelope<AccountEvent>>... singletonProjections) {
        this.singletonProjections = List.of(singletonProjections);
        return this;
    }

    public ProjectionLauncher withLocalProjections(Projection<EventEnvelope<AccountEvent>>... localProjections) {
